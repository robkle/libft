...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/10/22 16:24:22 by rklein            #+#    #+#              #
#    Updated: 2019/10/30 16:41:41 by rklein           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_lstnew.c ft_lstadd.c ft_lstiter.c ft_lstdelone.c
...
ft_lstnew.o ft_lstadd.o ft_lstiter.o ft_lstdelone.o
